...
import com.michael.kissaudio.ui.PlayerScreen
import com.michael.kissaudio.ui.PlayerViewModel
import com.michael.kissaudio.ui.theme.KISSAudioTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleIntent(intent: android.content.Intent?) {
        ...
        when (intent.action) {
            "com.michael.kissaudio.ACTION_LOAD_CHANNEL" -> {
                val channelId = intent.getIntExtra("channel_id", -1)
                if (channelId != -1) {
                    viewModel.selectChannel(channelId)
                }
            }
            "com.michael.kissaudio.ACTION_LOAD_EPISODE" -> {
