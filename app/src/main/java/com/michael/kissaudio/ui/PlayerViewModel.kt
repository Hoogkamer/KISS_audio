...
import com.michael.kissaudio.KISSAudioApp
import com.michael.kissaudio.data.*
import com.michael.kissaudio.podcast.PodcastRepository
import com.michael.kissaudio.scanner.AudioFile
import com.michael.kissaudio.scanner.FolderScanner
import com.michael.kissaudio.service.MusicService
...
data class PodcastState(
    ...
    val searchResults: List<com.michael.kissaudio.podcast.PodcastSearchResult> = emptyList()
)

class PlayerViewModel(application: Application) : AndroidViewModel(application) {

    private val app = application as KISSAudioApp
    ...
    fun setFolder(uri: Uri, name: String) {
        viewModelScope.launch {
            ...
            getApplication<KISSAudioApp>().contentResolver.takePersistableUriPermission(uri, android.content.Intent.FLAG_GRANT_READ_URI_PERMISSION)
    ...
    fun searchPodcasts(query: String) {
        viewModelScope.launch {
            val results = com.michael.kissaudio.podcast.PodcastSearchClient.searchPodcasts(query)
